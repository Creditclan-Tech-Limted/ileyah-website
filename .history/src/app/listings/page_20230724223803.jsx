          ...
          <div className="flex items-center">
            ...
            <div className=" flex justify-between items-center">
              ...
              <div className=" flex justify-between items-center gap-2">
                <div className=" w-10 h-12 bg-gray-400 hover:bg-orange-600 cursor-pointer hover:text-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <div className=" w-8 h-8 bg-gray-400 hover:bg-orange-600 cursor-pointer hover:text-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
