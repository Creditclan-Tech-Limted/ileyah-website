  ...
  return (
    <div>
      <div className="max-w-sm w-full bg-white lg:max-w-full lg:flex p-8 shadow-lg">
        <div
          className="h-48 lg:h-72 lg:w-80 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden hover:scale-125 transition duration-500 cursor-pointer"
