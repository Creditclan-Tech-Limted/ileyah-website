    ...
    <>
      ...
      <div className="space-y-5 p-8 flex flex-col">
        ...
        <div className="flex space-x-5">
          <Button block onClick={scheduleInspections} variant='outlined' color='black'> Schedule Inspection </Button>
          <Button block onClick={scheduleInspections}> I want this </Button>
        </div>
