...
function CompanyIdUplod({ onBack, onNext }) {
          ...
          <>
            <div className='cropper'>
              <Cropper
                ...
                guides={true}
              />
              <div className='mt-4 w-100 flex justify-content-center'>
                <button
          ...
          <>
            <div className='pt-70 pb-2'>
              ...
              <p className='text-cc-dark font-17'>
                Kindly upload a picture of your company Id Card
              </p>
            </div>
            <div>
