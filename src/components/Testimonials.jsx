      ...
      <div className="mx-auto max-w-7xl">
        <div className="">
          ...
          <p className="mt-6 text-lg tracking-tight text-slate-700">
            At Ileyah, we've developed a revolutionary Fintech solution that
            allows you to split your payments and make real estate ownership
            more accessible and manageable. With our Split Payments service, you
            can take a step towards your dream home without the burden of
              ...
              <swiper-slide key={i}>
                <div className="mx-3">
                  <figure className="relative rounded-3xl bg-white shadow-md px-10 py-14">
                    ...
                    <figcaption className="relative mt-6 flex items-center justify-end pt-3 text-right">
                      <div>
