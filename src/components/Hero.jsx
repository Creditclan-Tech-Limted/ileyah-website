    ...
    <>
      <section className="bg-white font-nunito">
        <div className="container">
          <div className="grid max-w-screen-xl mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12 pt-36 pb-20">
            <div className="mr-auto place-self-center lg:col-span-6 pt-24 pb-32">
              <h1 className="max-w-2xl mb-4 text-6xl md:text-5xl xl:text-[5.5rem] font-extrabold tracking-tight text-[#020952]">
            ...
            <div className="col-span-6">
              <div className="relative">
                <div className="absolute h-[300px] w-[300px] bg-[#F4BD68] rounded-full left-[0rem] md:left-[7rem]">
                  <div className='relative h-[300px] w-[300px] rounded-full after:content-[""] after:absolute after:h-[30px] after:w-[30px] after:rounded-full after:bg-[#02163B] after:top-[4rem] after:border-2 after:border-white rotate' />
                </div>
                <div className="absolute h-[300px] w-[300px] bg-[#EE6C4C] rounded-full right-[-1rem] md:right-[3rem] top-[10rem]">
                  <div className='relative h-[300px] w-[300px] rounded-full after:content-[""] after:absolute after:h-[30px] after:w-[30px] after:rounded-full after:bg-[#F4BD68] after:top-[4rem] after:border-2 after:border-white rotate animation-duration-8' />
                </div>
                <div className="absolute h-[150px] w-[150px] bg-[#02163B] rounded-full top-[27rem] right-[13rem] md:right-[18rem]">
                  <div className='relative h-[150px] w-[150px] rounded-full after:content-[""] after:absolute after:h-[25px] after:w-[25px] after:rounded-full after:bg-[#ED6B49] after:top-[6rem] after:border-2 after:border-white rotate animation-delay-3' />
                </div>
                <div className="z-20 relative">
                  <div className="absolute bg-gray-50 w-[300px] rounded-lg top-[3rem] right-[1rem] md:right-[7rem] shadow-md p-4 bounce">
                    <div className="relative pb-6">
                      ...
                      <div className="py-6">
                        ...
                        <p className="md:text-sm text-gray-600 pb-2">
                          Contact us today to finance your rent while you pay us
                      ...
                      <div className="relative">
                        <div className="flex bg-white rounded-lg p-4 flex-col text-center shadow-lg slant-card">
                          <img
                            ...
                            src="/assets/images/houses/1.jpg"
                            alt=""
                          />
                          <div className="flex mt-4 items-center">
                            <img
                              className="w-[50px] h-[50px] rounded-lg"
                              src="/assets/images/agents/1.png"
                              alt=""
                            />
                            <div className="ml-4 text-left">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="bathrooms mr-3">
                                  <i className="fa-solid fa-bath mr-1"></i>2
                                </div>
                                <div className="toilets mr-3">
                                  <i className="fa-solid fa-toilet mr-1"></i>3
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="flex bg-white rounded-lg p-4 flex-col text-center shadow-lg slant-card-two">
                          <div className="relative">
                            ...
                            <div className="flex mt-4 items-center">
                              <img
                                className="w-[50px] h-[50px] rounded-lg"
                                src="/assets/images/agents/2.png"
                                alt=""
                              />
                              <div className="ml-4 text-left">
                                <p className="md:text-lg text-gray-600 font-bold">
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="bathrooms mr-3">
                                    <i className="fa-solid fa-bath mr-1"></i>3
                                  </div>
                                  <div className="toilets mr-3">
                                    <i className="fa-solid fa-toilet mr-1"></i>4
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div className="flex bg-white rounded-lg p-4 flex-col text-center shadow-lg slant-card-three">
                          ...
                          <div className="flex mt-4 items-center">
                            <img
                              className="w-[50px] h-[50px] rounded-lg"
                              src="/assets/images/agents/3.png"
                              alt=""
                            />
                            <div className="ml-4 text-left">
                              <p className="md:text-lg text-gray-600 font-bold">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="bathrooms mr-3">
                                  <i className="fa-solid fa-bath mr-1"></i>1
                                </div>
                                <div className="toilets mr-3">
                                  <i className="fa-solid fa-toilet mr-1"></i>1
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="flex bg-white rounded-lg p-4 flex-col text-center shadow-lg slant-card-four">
                          ...
                          <div className="flex mt-4 items-center">
                            <img
                              className="w-[50px] h-[50px] rounded-lg"
                              src="/assets/images/agents/4.png"
                              alt=""
                            />
                            <div className="ml-4 text-left">
                              <p className="md:text-lg text-gray-600 font-bold">
