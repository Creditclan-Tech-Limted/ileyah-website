            ...
            <section class="bg-white font-nunito">
                <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:pt-[40px] pb-[100px] lg:grid-cols-12">
                    <div class="mr-auto place-self-center lg:col-span-6 pt-[100px]">
                        <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight md:text-5xl xl:text-[3.5rem] text-primary">
                            Providing <br/> <span className="text-secondary">rent solutions</span> <br/> across Africa
                        </h1>
                        <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl text-primary">Introducing flexible payment
                        solutions in the real estate sector. Become a homeowner today</p>
                        <a href="#"
                           class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-primary rounded-lg border border-primary hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                            Get started
                        ...
                        <a href="#"
                           class="px-8 inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 bg-secondary rounded-lg hover:bg-transparent hover:border-secondary hover:text-secondary text-white hover:border focus:ring-4 focus:ring-gray-100">
                            See plans
                        </a>
                    </div>
