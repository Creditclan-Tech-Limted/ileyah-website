    ...
    <>
      <div className=" py-20 md:py-32">
        <div className="container pt-5">
          <div className="flex-row md:flex items-center justify-center space-x-16">
            <div className="ps-md-5 mt-5 mt-md-0">
              <img
                src="/assets/images/ileyahbot_iphone13blue_portrait.png"
                alt=""
                style={{ width: "400px" }}
              />
            </div>
            <div className="text-left flex flex-col items-start">
              ...
              <div className="text-lg">
                {source === "landlord"
                  ...
                  : " Connect us with your landlord and we take it from there."}
              </div>
