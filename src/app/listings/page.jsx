...
const Page = () => {
  ...
  const onTopCategoryAreaFilter = async (filter) => {
    try {
      setLoadingFilter(true);
      const res = await axios.get(
        `${apiUrl}filter_by_search_params?area=${filter}`
      );
      setLoadingFilter(false);
      setIsFiltering(true);
      setFilterData([...res?.data]);
  ...
  const cancelFilter = () => {
    ...
    setIsFiltering(false), setIsFilterAboveMarkAction(true);
  ...
  return (
    <div className="bg-gray-100">
        ...
        <div className="">
          ...
          <div className="border-gray-300 border px-8 py-6 bg-blue-900 rounded-2xl text-white space-y-6 navbar_bg2 mt-4 md:hidden">
            <p className="inline-flex">
              ...
              <span className="">Didn't find what you're looking for?</span>
            </p>
            <Button
              color="white"
              size="sm"
              onClick={() => (setCall(true), setShowModal(true))}
            >
              Post a Request
            </Button>
          </div>
          ...
          <div className={`md:grid md:grid-cols-[1fr_350px] gap-10 mt-10`}>
            ...
            <div className="hidden md:block">
              ...
              <div>
                <p className="mb-3 italic mt-10">
                  Setup your Subscription Services
                </p>
                <div
                  ...
                  onClick={() => setOpenStandAlonePlans(true)}
                >
                  <div className="flex">
                    <div className="flex">
              ...
              <div className="bg-white rounded-2xl p-10 max-h-[770px] space-y-10 sticky top-[30px] mt-10">
                <form
                  onSubmit={handleSubmit(onFilterProperty)}
                  className="space-y-6"
                >
                  <div>
                    <p>House Type</p>
                  ...
                  <div>
                    <div className="w-full my-4">
                      <Input
                        bordered
                        label="Maximum Rent Amount"
                        {...register("price", {
                          min: {
                            value: 300000,
                            message:
                              "Please provide an amount greater than ₦100,000",
                          },
                          max: {
                            value: 3000000,
                            message:
      ...
      <SuscriptionStandAlone
        isOpen={openStandAlonePlans}
        onClose={() => setOpenStandAlonePlans(false)}
      />
    </div>
  );
};
