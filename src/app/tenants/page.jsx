          ...
          <div className="container">
            <div className="grid grid-cols-1">
              <div className="text-center">
                <h1 className="font-bold lg:leading leading-normal text-4xl lg:text-8xl mb-6">Are you ready to find your dream home</h1>
                ...
                <div className="subcribe-form relative z-10 mt-8">
