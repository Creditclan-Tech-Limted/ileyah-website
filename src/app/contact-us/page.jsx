...
const Page = () => {
  ...
  return (
    ...
    <ScrollToTop />
      <Navbar />
      <section className="relative z-10 overflow-hidden bg-white py-20 lg:py-[200px]">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">(+235) 9055 552 255</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color text-base">support@ileyah.com</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-yellow-500 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
