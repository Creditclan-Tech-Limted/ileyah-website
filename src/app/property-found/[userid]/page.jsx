        ...
        <div className="container">
          {
            loading && (
              [1, 2, 3].map((m, i) => (
                <div role="status" className="space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center mt-5" key={i}>
                  ...
                  <div className='hidden md:block'>
                    ...
                    <div className='mt-3 bg-white shadow rounded-lg pl-10 pr-10 pt-10 text-xl h-[350px] relative border'>
                      <p className='text-4xl font-medium'>
                        Experience peace. Pay your rent Monthly <span className="text-primary-600" /> forever.{' '}
