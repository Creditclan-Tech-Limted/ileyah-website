  ...
  const signUpAndCreate = async (values) => {
    try {
      const payload = {
        ...
        amount: data?.signUpAndCreate?.price || data?.createUserRequest?.price,
        house_type:
          data?.createUserRequest?.house_type ||
          data?.signUpAndCreate?.house_type,
        address:
          data?.signUpAndCreate?.address || data?.createUserRequest?.address,
        landlord_phone: "09055552255",
        picture: data?.signUpAndCreate?.image || data?.createUserRequest?.image,
      };
