      ...
      <Drawer title='Loan Details' isOpen={isOpen} onClose={onClose} longer={true}>
        <div>
          <div className="grid grid-cols-5 gap-10">
            <div
              className={views === 'bio' ? 'rounded-full px-4 py-2 bg-black text-white text-center cursor-pointer' : 'rounded-full px-4 py-2 text-center cursor-pointer'}
              onClick={() => setViews('bio')}>Details
            </div>
            <div
              className={views === 'schedules' ? 'rounded-full px-4 py-2 bg-black text-white text-center cursor-pointer' : 'rounded-full px-4 py-2 text-center cursor-pointer'}
              onClick={() => setViews('schedules')}>Schedules
            </div>
            <div
              className={views === 'payments' ? 'rounded-full px-4 py-2 bg-black text-white text-center cursor-pointer' : 'rounded-full px-4 py-2 text-center cursor-pointer'}
              onClick={() => setViews('payments')}>Payments
            </div>
            <div
              className={views === 'upfront' ? 'rounded-full px-4 py-2 bg-black text-white text-center cursor-pointer' : 'rounded-full px-4 py-2 text-center cursor-pointer'}
              onClick={() => setViews('upfront')}>Upfront
            </div>
            <div
              className={views === 'comments' ? 'rounded-full px-4 py-2 bg-black text-white text-center cursor-pointer' : 'rounded-full px-4 py-2 text-center cursor-pointer'}
              onClick={() => setViews('comments')}>Comments
            </div>
          </div>
