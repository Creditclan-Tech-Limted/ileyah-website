        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className='space-y-10'>
            ...
            <div className="grid grid-cols-2 gap-10">
              ...
              <Select
                options={sectors} label='Status' bordered
                {...register('sectors', {
                  required: {
                    value: true,
          ...
          <div className='mt-10'>
            ...
            <div className='grid grid-cols-2 gap-10 mb-10'>
              <Input
                label='Name'
                bordered
                {...register('landlor_name', {
                  required: {
                    value: true,
                    message: 'landlor_name is required',
                  },
                })}
                error={errors?.landlor_name?.message}
              />
              <Input
                label='Phone Number'
                bordered type='number'
            ...
            <div className="flex items-center justify-between border border-gray-300 rounded-3xl px-6 py-6">
              ...
              <div>
                <div className="flex items-center">
                  <label
                    className="border-2 border-gray-300 border-dashed w-[150px] h-[50px] rounded-2xl flex justify-center items-center hover:bg-gray-100 cursor-pointer relative"
                  >
                    <input
                      type="file" multiple className="w-[1px] h-[1px] absolute top-0 left-0" onChange={onChange}
                    />
                    {
          ...
          <div className="mt-10">
            <Button leftIcon={<IconPlus />} >Add Property</Button>
          </div>
        </form>
      </Drawer>
    </>
