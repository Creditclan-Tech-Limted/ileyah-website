  ...
  const getRecoveryInfo = async () => {
    try {
      const res = await axios.post(
        ...
        { creditclan_request_id: request.creditclan_request_id },
        {
          headers: {
            "x-api-key":
                              ...
                              <div className="text-center items-center justify-center">
                                <div className="border-gray-300 rounded-2xl border-2 divide-y">
                                  <p className="flex justify-between p-3">
                                    ...
                                    <div>
                                      {formatCurrency(
                                        upfront?.transaction_payload?.amount
                                      )}
                                    </div>
                                  </p>
                                  ...
                                  <div className="flex justify-between p-3">
                                    ...
                                    <div>
                                      {upfront?.transaction_payload?.craccount}
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="text-center items-center justify-center">
                              <div className="border-gray-300 rounded-2xl border-2 divide-y">
                                ...
                                <div className="flex justify-between p-3">
                                  ...
                                  <div>
                                    {loan?.loan?.offers[0]?.monthly_repayment}
                                  </div>
                                </div>
                                <div className="flex justify-between p-3">
                                  <div>Duration:</div>
                              ...
                              <div className="text-center items-center justify-center">
                                <div className="border-gray-300 rounded-2xl border-2 divide-y">
                                  <div className="flex justify-between p-3">
                                    ...
                                    <div>
                                      {recovery?.customer?.account_number}
                                    </div>
                                  </div>
                                  <div className="flex justify-between p-3">
                                    <div>Bank name:</div>
                              ...
                              <table className="w-full text-sm text-left text-gray-500 shadow-md">
                                ...
                                {schedules?.map((item, i) => (
                                  <tr key={i}>
                                    ...
                                    <td className="px-6 py-4">
                                      {(+item.total_fines_so_far || 0).toFixed(
                                        2
                                      )}
                                    </td>
                                    <td className="px-6 py-4">
                                    ...
                                    <td className="px-6 py-4">
                                      {(+item.how_much_remaining || 0).toFixed(
                                        2
                                      )}
                                    </td>
                                  </tr>
