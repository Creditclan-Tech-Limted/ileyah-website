...
export default function ListingsGrid({
  ...
  return (
    <>
      <div
        className="max-w-md rounded relative overflow-hidden shadow m-auto mt-4 cursor-pointer h-[400px] flex flex-col"
        onClick={() => setOpenPropertyDetails(true)}
      >
        <div>
          <img
          ...
          <div className="p-4 space-y-3">
            ...
            <p>
              {property?.area} - {property?.createdAt?.slice(0, 10)}{" "}
            </p>
          </div>
        </div>
