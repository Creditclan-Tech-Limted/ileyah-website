...
const RenewRentDashboard = ({ isOpenDrawer, onClose }) => {
  ...
  const salaryEarnerOrBusinessOwner = [
    { value: "salary-earner", text: "Salary Earner" },
  ...
  return (
    <>
      ...
      >
        {views === "request" && (
          <>
            <h3 className="text-xl max-w-sm font-medium mb-10 flex">
              <IconChevronLeft
                onClick={onClose}
                className="border border-black rounded-full mb-3 mr-3 cursor-pointer"
              />
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-6">
                    <Input
                      ...
                      {...register("amount", {
                        ...
                        //   value: 300000,
                        //   message:
                        //     "Please provide an amount greater or euqals ₦300,000",
                        // },
                        // max: {
                        //   value: 3000000,
                        //   message:
                        //     "Please provide an amount less than ₦3million",
                        // },
                      })}
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    />
                    <Select
                      options={salaryEarnerOrBusinessOwner}
                      label="Salary Earner or Business Owner"
                      bordered
                      {...register("salaryEarnerOrBusinessOwner", {
                        required: {
                          value: true,
                          message:
                            "Salary Earner or Business Owner is required",
                        },
                      })}
                      error={errors?.salaryEarnerOrBusinessOwner?.message}
                    />
                  </div>
                  {/* <Input
        ...
        {views === "request-details" && <RequestDetails />}
        ...
        {!!image && (
          <Modal isOpen={isOpen} size="md">
            ...
            <div className="flex justify-center mt-5 space-x-3">
              <Button onClick={handleCancel} variant="outlined" color="red">
                Cancel
              </Button>
